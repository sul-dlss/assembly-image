...
The gem assumes that the user context in which it is executed has write access to the location where the gem is installed.
...
The gem uses a "profiles" folder within the gem itself for this purpose, and assumes it is writable.
